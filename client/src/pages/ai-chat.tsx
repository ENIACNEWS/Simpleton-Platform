  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: 'var(--background)', color: 'var(--foreground)' }}>
      ...
      <div className="flex-1 flex flex-col max-w-4xl mx-auto w-full px-4 pt-20 pb-24">
        ...
        <div className="flex-1 overflow-y-auto rounded-xl border p-4 mb-4" style={{ backgroundColor: 'var(--card)', borderColor: 'var(--border)', minHeight: '400px' }}>
          {messages.length === 0 ? (
                      ...
                      >
                        ...
                        <div className={`max-w-[80%] ${msg.role === "user" ? "order-first" : ""}`}>
                          <div
                            ...
                            style={msg.role === "user"
                              ? { backgroundColor: 'color-mix(in srgb, var(--primary) 25%, var(--card))', color: 'var(--foreground)', border: '1px solid color-mix(in srgb, var(--primary) 40%, transparent)' }
