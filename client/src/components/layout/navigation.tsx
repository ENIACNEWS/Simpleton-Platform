        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              {/* Simpleton Mode - clean minimal icon on mobile */}
              <Link
                href="/simpleton-mode"
                className="lg:hidden flex items-center justify-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-medium transition-all duration-200 hover:opacity-90 active:scale-95 border border-white/20 backdrop-blur-sm"
                style={{ background: 'rgba(255,255,255,0.08)', color: 'var(--accent)' }}
                title="Simpleton Mode"
              >
                <Sparkles className="w-3.5 h-3.5" />
                <span className="hidden sm:inline text-white/90">Simple</span>
              </Link>
