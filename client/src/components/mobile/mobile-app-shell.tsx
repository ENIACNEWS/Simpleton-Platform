...
const moreMenuItems: MoreMenuItem[] = [
  ...
  { label: "Precious Metals", icon: Calculator, path: "/calculator", description: "Gold, silver & platinum calculator" },
  ...
  { label: "Diamonds", icon: Diamond, path: "/diamonds", description: "Diamond search & database" },
    ...
    { label: "News Hub", icon: Tv, path: "/news-hub", description: "Live financial news streams" },
              ...
              <div className="overflow-y-auto" style={{ maxHeight: "calc(85vh - 60px)" }}>
                ...
                <div className="px-4 py-3" style={{ borderTop: "1px solid rgba(255,255,255,0.06)" }}>
                  ...
                  >
                    <div
                      className="w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0"
                      style={{ background: "rgba(0,113,227,0.08)", border: "1px solid rgba(0,113,227,0.12)" }}
                    >
